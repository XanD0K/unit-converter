...
class Converter:
    ...
    def groups(self) -> str:
        ...
        return message
###################### ADD VALIDATIONS TO GROUP, HISTORY AND TYPES IN DATA_MODELS.PY
    ...
    # 'convert' action
    def convert(self, unit_group: str, user_input: str, print_result: bool=False):
    ...
    # 'manage-group' action
    def manage_group(self, unit_group: str, user_input: str, print_message: bool=False):
    ...
    # 'manage-type' action
    def manage_type(self, unit_group: str, user_input: str, print_message: bool=False):
    ...
    # 'aliases' action
    def aliases(self, unit_group: str, user_input: str, print_message: bool=False):
    ...
    # 'change-base' action
    def change_base(self, unit_group: str, user_input: str, print_message: bool=False):
