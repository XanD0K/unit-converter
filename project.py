...
from unit_converter.data_manager import load_data, validate_dicts, add_to_log, refactor_value, zero_division_checker, save_data



# Opens all dictionaries
units, base_units, conversion_log, unit_aliases, month_days = load_data()

# Validates all dictionaries
validate_dicts(units, base_units, conversion_log, unit_aliases, month_days)
...
def add_new_group(unit_group) -> None:
    ...
    save_data(units, "units")
    save_data(base_units, "base_units")    
...
def manage_aliases(unit_group=None, unit_type=None, action=None, alias=None):
    ...
    unit_aliases = save_data(unit_aliases, "unit_aliases")
